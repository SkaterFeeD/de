...
<div class="menu">
    ...
    <ul class="menu-list">
        ...
        <li><img src="../../public/assets/images/group.svg" alt="Группы"><a href="#">Группы и <br>пользователи</a></li>
        <li><img src="../../public/assets/images/files.svg" alt="Файлы"><a href="#">Файлы</a></li>
        <li><img src="../../public/assets/images/check.svg" alt="Проверка"><a href="#">Проверка</a></li>
